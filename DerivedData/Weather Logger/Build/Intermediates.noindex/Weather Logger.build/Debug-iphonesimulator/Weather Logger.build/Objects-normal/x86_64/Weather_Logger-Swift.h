...
SWIFT_MODULE_NAMESPACE_PUSH("Weather_Logger")
@class UIWindow;
@class UIApplication;
@class UISplitViewController;
@class UIViewController;

SWIFT_CLASS("_TtC14Weather_Logger11AppDelegate")
...
SWIFT_CLASS("_TtC14Weather_Logger20DetailViewController")
...
@interface Event (SWIFT_EXTENSION(Weather_Logger))
...
SWIFT_CLASS("_TtC14Weather_Logger20MasterViewController")
